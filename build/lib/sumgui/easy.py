...
class AlertBox(Widget):
    ...
    def draw(self, screen):
        # PyDroid3/Android is very sensitive to allocating a full-screen
        # alpha Surface every frame.  Use a solid dim background instead.
        pygame.draw.rect(screen, (8, 8, 8), self.rect);
