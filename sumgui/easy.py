...
def textarea(x, y, w, h, text="", font_size=None, accepts_tab=True, tab_size=4, syntax=None, show_v_scrollbar=True, show_h_scrollbar=True):
    ...
    return current.add(TextArea(pygame.Rect(x, y, w, h), use_font, text, True, True, True, -1, -1, current.theme, show_v_scrollbar=show_v_scrollbar, show_h_scrollbar=show_h_scrollbar, accepts_tab=accepts_tab, tab_size=tab_size, syntax=syntax));
